	...
	return (
		<div class="space-y-2">
			...
			<select
				...
				class="h-12 w-full border-4 border-border bg-background px-3 font-bold text-sm shadow-[4px_4px_0_0_#000] outline-none transition-all focus:translate-x-1 focus:translate-y-1 focus:shadow-none disabled:cursor-not-allowed disabled:opacity-50"
			>
